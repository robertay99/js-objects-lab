...
*/
const trueForGymsBelowSix = game.gyms.forEach((gym) => {
...
game.gymStatus = function() {
    ...
    game.gyms.forEach((gym) => {
        if(gym.completed === true) gymTally.completed +=1
        if(gym.completed === false) gymTally.incomplete += 1
    })
...
game.partyCount = game.party.reduce((acc, obj) => acc += 1, 0)
...
*/
const trueForGymsBelowEight = game.gyms.forEach((gym) => {
